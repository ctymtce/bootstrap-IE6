...
!function($) {
    ...
    Datepicker.prototype = {
        ...
        setValue: function() {
            ...
            old = old.replace(/\d{4}\-\d{1,2}\-\d{1,2}/, formated); 
            if(old.length < 9) {
                formated += ' ' + old;
            }else {
                formated = old;
        ...
        setTime: function(ctime) {
            ...
            old = old.replace(/[^0-9\:\-\s]/gi,'').replace(/^\s*/g,'').replace(/\s*$/g,'');
            formated = old.replace(/\s*\d{1,2}\:\d{1,2}\:\d{1,2}\s*/, ' '+ctime);
    ...
    var DPGlobal = {
        ...
        headTemplate: '<thead>'+
                            ...
                            '<tr>'+
                                ...
                                '<th colspan="3" class="ctime">{ctime}</th>'+
...
;(function($){
    $.fn.extend({
        drag: function(){
            ...
            $(window).on('mousemove', jObj.dragMove);
